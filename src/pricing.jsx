...
<div class="overflow-hidden">
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="mx-auto max-w-2xl mb-8 lg:mb-14 text-center">
      ...
      Unlock A-Q-G at Competitive Prices
      </h2>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        <div>
          ...
          <div class="p-4 relative z-10 bg-white border rounded-xl md:p-10 ">
            ...
            <div class="text-sm text-gray-500 ">Advanced Features for Growing Teams or Large-Scale Use</div>
            ...
            <div class="mt-5 grid sm:grid-cols-2 gap-y-2 py-4 first:pt-0 last:pb-0 sm:gap-x-6 sm:gap-y-0">
              ...
              <ul class="space-y-2 text-sm sm:text-base">
                <li class="flex gap-x-3">
                  ...
                  <span class="text-gray-800 ">
                    Custom qn generation on user input
                  </span>
                </li>
            ...
            <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
              ...
              <div class="flex justify-end">
                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent  ">Start free trial</button>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10  ">
            ...
            <div class="text-sm text-gray-500 ">Perfect for small Teams or Personal Use</div>
            ...
            <div class="mt-5">
              <span class="text-6xl font-bold text-gray-800 ">$19</span>
            ...
            <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
              ...
              <div class="flex justify-end">
                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Start free trial</button>
              </div>
            </div>
          </div>
